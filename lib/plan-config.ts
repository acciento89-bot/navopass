...
export const PLAN_CONFIG: Record<Plan, PlanDefinition> = {
  ...
  BUSINESS: { id:"BUSINESS", name:"Business", monthlyCents:5999, yearlyCents:59900, maxAssets:1000, maxStorageBytes:50*GB, maxSeats:10, maxSharedWorkspaces:null, description:"Für Unternehmen und Teams mit Kunden, Objekten, Einsatzplanung, Mitarbeiterzuweisung und nachvollziehbaren Arbeits-, Service- oder Prüfberichten." },
};
