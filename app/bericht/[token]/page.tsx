...
export default async function SharedReportPage({params}:{params:Promise<{token:string}>}){
  ...
  return <main className={styles.page}><article className={styles.sheet}>
    ...
    <footer className={styles.footer}><span>Geschützter historischer NavoPass-Servicebericht · {reportNumber}</span><span>Der Link ist zeitlich begrenzt.</span></footer>
  </article></main>;
}
