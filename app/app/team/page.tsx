  ...
  return (
    <main className="app-page">
      <div className="container">
        ...
        {inviteUrl && <section className="invite-result"><div><span className="eyebrow">Einladung erstellt</span><h2>{params.emailState === "sent" ? "Einladung wurde per E-Mail versendet" : "Einladungslink ist bereit"}</h2><p>{params.emailState === "sent" ? "Die eingeladene Person hat den Link per E-Mail erhalten. Du kannst ihn bei Bedarf zusätzlich direkt weitergeben." : params.emailState === "failed" ? "Der E-Mail-Versand hat nicht funktioniert. Die Einladung selbst ist gültig – gib den Link bitte direkt weiter." : "Der Mailversand ist noch nicht konfiguriert. Gib den Link bitte direkt an die eingeladene Person weiter."}</p></div><code>{inviteUrl}</code><p className="muted">Der Link ist 7 Tage gültig und funktioniert nur mit der eingeladenen E-Mail-Adresse.</p></section>}
