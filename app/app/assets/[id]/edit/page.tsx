    ...
    <main className="app-page">
      <div className="container">
        ...
        <section className="editor-card">
          <div className="section-heading left"><span className="eyebrow">Objektpass bearbeiten</span><h1>{asset.name}</h1><p>Ändere Stammdaten, Termine, Freigabe und Notizen. Historie und Dokumente bleiben erhalten.</p></div>
          <form action={updateAssetAction} className="form-grid">
            ...
            <label>Sichtbarkeit<select name="visibility" defaultValue={asset.visibility}><option value="PRIVATE">Privat – nur ich</option><option value="LINK">Per Link/QR – wer den Link hat</option><option value="PUBLIC">Öffentlich</option></select></label>
