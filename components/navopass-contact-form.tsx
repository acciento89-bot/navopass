...
export function NavoPassContactForm({ sent = false, error }: { sent?: boolean; error?: string }) {
  return (
    <form action={sendContactAction} id="kontaktformular">
      ...
      <label className={styles.consent}><input name="privacy" type="checkbox" required /><span>Ich habe die <Link href="/datenschutz">Datenschutzerklärung</Link> gelesen. Meine Angaben werden zur Bearbeitung meiner Anfrage an Kamilunavo übermittelt.</span></label>
